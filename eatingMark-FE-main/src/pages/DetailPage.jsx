...
const DetailPage = () => {
  ...
  const [place] = useState({
    id: 'r1',
    name: '을지로 골목냉면',
    description: '시원한 육수와 쫄깃한 면발이 일품인 을지로 대표 냉면 맛집입니다. 30년 전통의 비법 육수로 만든 냉면은 깔끔하면서도 깊은 맛을 자랑합니다. 고소한 육전과 신선한 물김치도 함께 즐겨보세요. 을지로의 정취를 느끼며 즐기는 냉면 한 그릇은 더운 여름날 최고의 선택이 될 것입니다.',
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div>
            ...
            {/* Save Button */}
            <button className="w-full bg-[#817D73] text-white py-3 rounded-lg mb-8">
              나의 맛집 목록에 저장하기
            </button>
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mb-4">
                {[1, 2, 3, 4, 5].map((star) => (
                  <span key={star} className="text-2xl text-gray-400 cursor-pointer hover:text-yellow-400">★</span>
                ))}
              </div>
